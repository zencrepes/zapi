...
export default class DataResolver {
  ...
  public async getItemsProperty(
    ...
    const data = await this.itemsService.findAll(first, size, parent.query, orderBy, 'gh_releases_');
    return data;
  }
  ...
  public async getAggregationsProperty(
    ...
    const data = await this.aggregationsService.findAll(field, parent.query, aggType, options, 'gh_releases_');
    return data;
  }
}
