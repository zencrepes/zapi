...
test('Nothing to remove, field is different', () => {
  const sourceQuery = {
    op: 'and',
    content: [
      { op: 'in', content: { field: 'my.fieldA', value: ['my.Value'] } },
    ],
  };
...
test('Nothing to remove, values are different (string)', () => {
  const sourceQuery = {
    op: 'and',
    content: [
      { op: '==', content: { field: 'my.fieldA', value: 'my.ValueA' } },
    ],
  };
...
test('Removing the only filter (value as string)', () => {
  const sourceQuery = {
    op: 'and',
    content: [{ op: '==', content: { field: 'my.fieldA', value: 'my.Value' } }],
  };
...
test('Nothing to remove, values are different (array, one value)', () => {
  const sourceQuery = {
    ...
    content: [
      {
        op: 'in',
        content: { field: 'my.fieldA', value: ['my.ValueB', 'my.ValueC'] },
      },
    ],
  };
  const filter = createTermFilter('in', 'my.fieldA', ['my.Value']);
...
test('Removing one value from one of two filters (value as array)', () => {
  const sourceQuery = {
    ...
    content: [
      ...
      {
        op: 'in',
        content: { field: 'my.fieldB', value: ['my.ValueB', 'my.ValueC'] },
      },
    ],
  };
  const filter = createTermFilter('in', 'my.fieldB', ['my.ValueB']);
  ...
  const sourceQuery = {
    ...
    content: [
      { op: 'in', content: { field: 'my.fieldA', value: ['my.ValueA'] } },
      {
        ...
        content: {
          field: 'my.fieldB',
          value: ['my.ValueB', 'my.ValueC', 'my.ValueE'],
        },
      },
    ],
  };
  const filter = createTermFilter('in', 'my.fieldB', [
    'my.ValueB',
    'my.ValueD',
    'my.ValueE',
  ]);
